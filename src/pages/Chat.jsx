    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-900 pb-24">
      ...
      <div className="hidden md:flex max-w-6xl mx-auto h-screen flex-col">
        <motion.div
          ...
          className="sticky top-0 bg-white/95 dark:bg-slate-950/95 backdrop-blur border-b dark:border-slate-800 p-4"
        >
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Meddelanden</h1>
            <Button 
        ...
        <div className="flex flex-1 gap-4 p-4 min-h-0">
          ...
          <div className="flex-1 flex flex-col bg-white dark:bg-slate-900 rounded-2xl shadow-sm dark:shadow-none dark:border dark:border-slate-800 overflow-hidden">
            {selectedConversation ? (
              <>
                ...
                <div className="border-b dark:border-slate-800 p-3 flex items-center gap-2">
                  {messages.length > 0 && (
                ...
                <form onSubmit={handleSendMessage} className="border-t dark:border-slate-800 p-4 flex gap-2">
                  <Input
      ...
      <div className="md:hidden max-w-2xl mx-auto h-screen flex flex-col">
        {selectedConversationId ? (
          <>
            <div className="sticky top-0 bg-white/95 dark:bg-slate-950/95 backdrop-blur border-b dark:border-slate-800 p-4 flex items-center gap-3">
              <Button
                variant="ghost"
                size="icon"
              ...
              <h2 className="font-semibold text-slate-900 dark:text-slate-100 flex-1">{selectedConversation?.title}</h2>
            </div>
          ...
          <>
            <div className="sticky top-0 bg-white/95 dark:bg-slate-950/95 backdrop-blur border-b dark:border-slate-800 p-4 space-y-3">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 text-left">
                          <p className="font-medium text-slate-900 dark:text-slate-100 text-sm">{u.full_name}</p>
