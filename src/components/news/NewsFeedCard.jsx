...
import { Heart, ThumbsUp, PartyPopper, MessageCircle, AlertTriangle } from "lucide-react";
...
export default function NewsFeedCard({ post, onReact, onComment, currentUserEmail }) {
  ...
  return (
    ...
    >
      <Card className={`overflow-hidden border-0 shadow-sm hover:shadow-md transition-all duration-300 ${post.is_important ? 'ring-2 ring-amber-400 bg-amber-50/30' : 'bg-white'}`}>
        {post.image_url && (
