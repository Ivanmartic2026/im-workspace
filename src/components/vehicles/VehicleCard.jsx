  ...
  return (
    ...
    >
      ...
      >
        <div className="flex">
          {vehicle.image_url ? (
            <div className="w-32 h-32 flex-shrink-0 overflow-hidden bg-slate-100 dark:bg-slate-800">
              <img 
            ...
            <div className="w-32 h-32 flex-shrink-0 bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-700 flex items-center justify-center">
              <Car className="h-12 w-12 text-slate-400 dark:text-slate-500" />
            </div>
          )}
          ...
          <CardContent className="py-4 px-4 flex-1">
            <div className="flex items-start justify-between gap-2 mb-2">
              <div className="min-w-0 flex-1">
                <h3 className="font-semibold text-slate-900 dark:text-slate-100 truncate group-hover:text-slate-700 dark:group-hover:text-slate-300 transition-colors">
