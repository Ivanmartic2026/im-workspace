        ...
        const emailBody = `
            <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto;">
                ...
                <table style="width: 100%; border-collapse: collapse; margin-top: 20px; background: white;">
                    <thead>
                        <tr style="background-color: #1e293b; color: white;">
                            <th style="padding: 12px; text-align: left;">Medarbetare</th>
                            <th style="padding: 12px; text-align: left;">Avdelning</th>
                            <th style="padding: 12px; text-align: right;">Timmar</th>
                            <th style="padding: 12px; text-align: center;">Antal pass</th>
                        </tr>
                    </thead>
                ...
                <table style="width: 100%; border-collapse: collapse; margin-top: 20px; background: white;">
                    <thead>
                        <tr style="background-color: #1e293b; color: white;">
                            <th style="padding: 12px; text-align: left;">Projektnamn</th>
                            <th style="padding: 12px; text-align: left;">Projektkod</th>
                            <th style="padding: 12px; text-align: right;">Timmar</th>
                            <th style="padding: 12px; text-align: center;">Antal personer</th>
                        </tr>
                    </thead>
